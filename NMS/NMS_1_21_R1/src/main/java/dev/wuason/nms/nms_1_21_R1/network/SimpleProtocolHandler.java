package dev.wuason.nms.nms_1_21_R1.network;
...
public final class SimpleProtocolHandler implements dev.wuason.nms.wrappers.SimpleProtocolHandler {
    ...
    public Object onAsyncPacketReceive(Player player, Object packet) {
        ...
        if (packet instanceof ServerboundRenameItemPacket renameItemPacket) {
            ...
            if (inventory instanceof AnvilView anvilInventory && inventory.getHolder() != null && inventory.getHolder() instanceof AnvilInventoryHolder anvilInventoryHolder) {
