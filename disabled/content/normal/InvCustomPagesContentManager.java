...
import dev.wuason.old.types.events.CloseEvent;
import dev.wuason.old.types.pages.content.normal.events.ContentClickEvent;
import dev.wuason.old.types.pages.content.normal.events.NextPageEvent;
import dev.wuason.old.types.pages.content.normal.events.OpenPageEvent;
import dev.wuason.old.types.pages.content.normal.events.PreviousPageEvent;
import dev.wuason.mechanics.inventory.items.ItemInterface;
import dev.wuason.old.types.pages.content.normal.items.NextPageItem;
import dev.wuason.old.types.pages.content.normal.items.PreviousPageItem;
