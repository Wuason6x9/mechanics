package dev.wuason.mechanics.nms.v1_20_R2;

import dev.wuason.mechanics.nms.others.AnvilInventoryHolder;
import dev.wuason.mechanics.nms.v1_20_R2.network.SimpleProtocolHandler;
...
public class Version implements VersionWrapper {
    ...
    public void sendToast(Player player, ItemStack icon, String titleJson, ToastType toastType, String namespace, String path) {
        ...
        Optional<DisplayInfo> displayInfo = Optional.of(new DisplayInfo(iconNMS, Component.Serializer.fromJson(titleJson), Component.literal("."), null, FrameType.valueOf(toastType.toString()), true, false, true));
    ...
    @Override
    public void sendToast(@NotNull Player player, @Nullable ItemStack icon, @NotNull String titleJson, @NotNull ToastType toastType) {
