package dev.wuason.mechanics.nms.v1_18_R2;

import dev.wuason.mechanics.nms.others.AnvilInventoryHolder;
import dev.wuason.mechanics.nms.v1_18_R2.network.SimpleProtocolHandler;
...
public class Version implements VersionWrapper {
    ...
    public void sendToast(Player player, ItemStack icon, String titleJson, ToastType toastType, String namespace, String path) {
        ...
        DisplayInfo displayInfo = new DisplayInfo(iconNMS, Component.Serializer.fromJson(titleJson), Component.nullToEmpty("."), null, FrameType.valueOf(toastType.toString()), true, false, true);
    ...
    public void openSing(Player player, String[] defLines, Consumer<String[]> onSend) {
        ...
        for (int i = 0; i < defLines.length; i++) {
            if (defLines[i] == null) {
                signBlock.setMessage(i, Component.nullToEmpty(""));
                continue;
            }
