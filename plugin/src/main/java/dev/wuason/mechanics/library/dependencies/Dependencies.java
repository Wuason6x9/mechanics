...
public class Dependencies {
    ...
    public static final Dependency ANTI_GRIEF = new Dependency("net:momirealms", "antigrieflib", "0.16",
            Remap.of("net:momirealms:antigrieflib", "dev:wuason:libs:antigrieflib")
    );
