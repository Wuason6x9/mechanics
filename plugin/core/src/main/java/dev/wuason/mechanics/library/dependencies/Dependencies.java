...
public class Dependencies {
    ...
    public static final Dependency RTAG = new Dependency("com:saicone:rtag", "rtag", "1.5.5",
            Remap.of("com:saicone:rtag", "dev:wuason:libs:saicone:rtag")
    );

    public static final Dependency RTAG_BLOCK = new Dependency("com:saicone:rtag", "rtag-block", "1.5.5",
            Remap.of("com:saicone:rtag", "dev:wuason:libs:saicone:rtag")
    );

    public static final Dependency RTAG_ENTITY = new Dependency("com:saicone:rtag", "rtag-entity", "1.5.5",
            Remap.of("com:saicone:rtag", "dev:wuason:libs:saicone:rtag")
    );

    public static final Dependency RTAG_ITEM = new Dependency("com:saicone:rtag", "rtag-item", "1.5.5",
            Remap.of("com:saicone:rtag", "dev:wuason:libs:saicone:rtag")
    );
